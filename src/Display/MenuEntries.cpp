...
const char TXT_MENU_ROOT[] PROGMEM = "Menu";
const char TXT_MENU_VIEW[] PROGMEM = "View";
...
const char TXT_MENU_BACK[] PROGMEM = "Back";
const char TXT_MENU_LIGHT[] PROGMEM = "Light on/off";
const char TXT_MENU_BLUETOOTH[] PROGMEM = "Bluetooth on/off";
const char TXT_MENU_PROFIL[] PROGMEM = "Profile 1/2";
const char TXT_MENU_EMERGENCY[] PROGMEM = "Emergency";
const char TXT_MENU_EM_BRAKE[] PROGMEM = "Ign. Brake";
const char TXT_MENU_EM_PEDAL[] PROGMEM = "Ign. Pedal";
const char TXT_MENU_EM_SPEED[] PROGMEM = "Ign. Speed";
const char TXT_MENU_EM_SPEEDCTRL[] PROGMEM = "Ign. SpeedCtrl";
...
const char TXT_MENU_TURN_OFF[] PROGMEM = "Turn Off";


const char TXT_MENU_COMPONENT[] PROGMEM = "Component";
const char TXT_MENU_COMPONENT_REPLACE[] PROGMEM = "Replace";
const char TXT_MENU_COMPONENT_REMOVE[] PROGMEM = "Remove";

const char TXT_MENU_COMPONENT_SELECTION[] PROGMEM = "Component Select";
