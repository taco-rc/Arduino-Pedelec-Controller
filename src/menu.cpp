...
static const char desc_display[] PROGMEM = "Desc ->";
...
static const char desc_main_lights_onoff[] PROGMEM = "Light on/off";
...
static const char desc_main_profile[] PROGMEM = "Profile 1<>2";
static MenuItem m_main_profile(desc_main_profile);

#ifdef SUPPORT_FIRST_AID_MENU
static const char desc_misc[] PROGMEM = "Misc ->";
static Menu menu_misc(desc_misc);

static const char desc_first_aid[] PROGMEM = "First Aid ->";
static Menu menu_first_aid(desc_first_aid);

static const char desc_first_aid_ignore_break[] PROGMEM = "Ign. Break";
